...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-w1-primary-dark text-w1-text-light pt-16">
      {/* Background gradient effect */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-black/30 z-0"></div>
      
      {/* Background image */}
      <img 
        src="/lovable-uploads/b955e097-2edd-4223-bf6f-4cbb102362f8.png" 
        alt="Consultores financeiros ajudando cliente" 
